...
var modelChanneldb = (function (_mysql) {
    _inherits(modelChanneldb, _mysql);

    function modelChanneldb() {
        _classCallCheck(this, modelChanneldb);

        _get(Object.getPrototypeOf(modelChanneldb.prototype), 'constructor', this).call(this);
        /**
         * @desc 产品线数据库
         */
        this.table = 'top_ch_db';
    }

    _createClass(modelChanneldb, [{
        key: 'getlist',
    ...
    return modelChanneldb;
})(_libMysql2['default']);

exports['default'] = new modelChanneldb();
