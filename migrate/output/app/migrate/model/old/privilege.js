...
var modelPrivilege = (function (_mysql) {
    _inherits(modelPrivilege, _mysql);

    function modelPrivilege() {
        _classCallCheck(this, modelPrivilege);

        _get(Object.getPrototypeOf(modelPrivilege.prototype), 'constructor', this).call(this);
        /**
         * @desc 顶级菜单
         */
        this.table = 'cms_privilege';
    }

    _createClass(modelPrivilege, [{
        key: 'getlist',
...
exports['default'] = new modelPrivilege();
